<?php
/*
Template Name: Калькулятор: Полис Путешественника
Template Post Type: page
*/
get_header();
?>
<link href="<?php echo get_template_directory_uri(); ?>/assets/css/w_vzr.css" rel="stylesheet">
<div class="header-body-clc">
			<h1><?php the_field('pp_title')?></h1>
	
			<div class="header-body-content-clc">

				<div class="tabs-body-buttons" id="tabs">
					<div class="tab tabs-body-buttons_item" id="one"><h3><?php the_field('pp_tab_1_title')?></h3></div>
					<div class="tab tabs-body-buttons_item" id="two"><h3><?php the_field('pp_tab_2_title')?></h3></div>
				...
				<div class="feature-img">
					<img src="<?php the_field('pp_tab_1_img')?>" alt="<?php the_field('pp_tab_1_title')?>">
				</div>
					<div class="feature-content">
						<h3 class="hide-mb"><?php the_field('pp_tab_1_title')?></h3>
						<div class="blue-line hide-mb"></div>
						<?php the_field('pp_tab_1_text')?>
					</div>
					</div>
				<div class="feature">
				<!-- От чего зависит стоимость? -->
				<div class="feature-img">
					<img src="<?php the_field('pp_tab_2_img')?>" alt="<?php the_field('pp_tab_2_title')?>">
				</div>
					<div class="feature-content">
						<h3 class="hide-mb"><?php the_field('pp_tab_2_title')?></h3>
						<div class="blue-line hide-mb"></div>
						<?php the_field('pp_tab_2_text')?>
					</div>
				</div>
