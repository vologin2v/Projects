...
function changeLocale(lang) {
    ...
    function getText(key, object, name, startIndex) {
        ...
        for ( ; elementKey < document.getElementsByClassName(name + "-" + key).length; elementKey++)
            if (!isNaN(elementKey)) document.getElementsByClassName(name + "-" + key)[elementKey].innerHTML = object[key];
    ...
    function getArrayText(key, object, name, startIndex) {
        ...
        for ( ; elementKey < document.getElementsByClassName(name + "-" + key).length; elementKey++)
            if (!isNaN(elementKey)) document.getElementsByClassName(name + "-" + key)[elementKey].innerHTML = object[key][elementKey % object[key].length];
    }
